                    ...
                    <section className={Style.terms}>
                        <div className={Style.terms__content}>
                            ...
                            <p className={Style.terms__text}>
                                ...
                                <Link to="/" className={Style.dapp__textlink}>&nbsp; here</Link>
                                . Join us,
                        ...
                        <div className={Style.dapp__links}>
                            <Link className={Style.dapp__linkyellow} to="/white-paper/business-model" onClick={scrollToTop}>
                                <img className={Style.dapp__button} src={ArrowBack} alt="back" />
                                Business Modal
                            </Link>
                            <Link className={Style.dapp__linkgreen} to="/white-paper/roadmap" onClick={scrollToTop}>
