                ...
                <div className={AppStyle.page}>
                    <section className={Style.terms}>
                        ...
                        <div className={Style.dapp__links}>
                            <Link className={Style.dapp__linkyellow} to="/white-paper" onClick={scrollToTop}><img className={Style.dapp__button}
                                src={ArrowBack} alt="back" />WhitePaper</Link>
                            <Link className={Style.dapp__linkgreen} to="/white-paper/values" onClick={scrollToTop}><img className={Style.dapp__button} src={ArrowNext}
