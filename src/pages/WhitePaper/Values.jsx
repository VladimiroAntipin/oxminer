                ...
                <div className={AppStyle.page}>
                    <section className={Style.terms}>
                        ...
                        <div className={Style.dapp__links}>
                            <Link className={Style.dapp__linkyellow} to="/white-paper/introduction" onClick={scrollToTop}><img className={Style.dapp__button}
                                src={ArrowBack} alt="back" />Introduction</Link>
                            <Link className={Style.dapp__linkgreen} to="/white-paper/principals" onClick={scrollToTop}><img className={Style.dapp__button} src={ArrowNext}
