                ...
                <div className={AppStyle.page}>
                    <section className={Style.terms}>
                        ...
                        <div className={Style.dapp__links}>
                            <Link className={Style.dapp__linkyellow} to="/white-paper/principals" onClick={scrollToTop}><img className={Style.dapp__button}
                                src={ArrowBack} alt="back" />Principals</Link>
                            <Link className={Style.dapp__linkgreen} to="/white-paper/how-it-works" onClick={scrollToTop}><img className={Style.dapp__button} src={ArrowNext}
