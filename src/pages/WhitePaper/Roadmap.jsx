                ...
                <div className={AppStyle.page}>
                    <section className={Style.terms}>
                        ...
                        <div className={Style.dapp__links}>
                            <Link className={Style.dapp__linkyellow} to="/white-paper/how-it-works" onClick={scrollToTop}>
                                <img className={Style.dapp__button} src={ArrowBack} alt="back" />
                                How it works?
                            </Link>
                            <Link className={Style.dapp__linkgreen} to="/white-paper/team" onClick={scrollToTop}>
