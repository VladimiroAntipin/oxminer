                ...
                <div className={AppStyle.page}>
                    <section className={Style.terms}>
                        ...
                        <div className={Style.dapp__links}>
                            <Link className={Style.dapp__linkyellow} to="/" onClick={scrollToTop}><img className={Style.dapp__button}
                                src={ArrowBack} alt="home" />Homepage</Link>
                            <Link className={Style.dapp__linkgreen} to="/white-paper/introduction" onClick={scrollToTop}><img className={Style.dapp__button}
